...
const Footer = () => {
    return (
        <FooterContainer>
            ...
            <FooterText><SocialMedia><a href=""><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                </a></SocialMedia><br/>&copy; {new Date().getFullYear()} Aromito Librería. Todos los derechos reservados.</FooterText>
        </FooterContainer>
    );
};
